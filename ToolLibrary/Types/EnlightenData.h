...
namespace Enlighten {
	...
	struct RadProbeSetMetaData {
		...
		uint16_t m_IsRegularGrid;
		uint16_t m_RegularGridResolutionX;
		uint16_t m_RegularGridResolutionY;
		uint16_t m_RegularGridResolutionZ;
...
struct EnlightenModule {
	...
	struct alignas(4) EnlightenLightSettings
	{
