...
#define DEFINETNOCOPY(name_,Ty,typename_) }++sMetaTypesCount;static MetaClassDescription meta_##name_; \
if(!(meta_##name_.mFlags.mFlags & MetaFlag::Internal_MetaFlag_Initialized)){ \
meta_##name_.mpVTable[0] = reinterpret_cast<void*>(MetaClassDescription_Typed<Ty>::New);\
meta_##name_.mpVTable[1] = reinterpret_cast<void*>(MetaClassDescription_Typed<Ty>::Delete);\
meta_##name_.mpVTable[2] = reinterpret_cast<void*>(MetaClassDescription_Typed<Ty>::Construct);\
meta_##name_.mpVTable[3] = reinterpret_cast<void*>(NULL);\
meta_##name_.mpVTable[4] = reinterpret_cast<void*>(MetaClassDescription_Typed<Ty>::Destroy);\
meta_##name_.mClassSize = sizeof(Ty);\
meta_##name_.mpTypeInfoExternalName = typeid(Ty).name();\
meta_##name_.Initialize(typename_);\
meta_##name_.mpVTable_ToContainerInterface = &_ContainerInterfaceCast<Ty>;

#define KEYOVERRIDE(t,mem,x) meta_##t##_##mem.mpIntrinsicKeyOverride = x;

#define DEFINET(name_,Ty,typename_) }++sMetaTypesCount;static MetaClassDescription meta_##name_; \
if(!(meta_##name_.mFlags.mFlags & MetaFlag::Internal_MetaFlag_Initialized)){ \
meta_##name_.mpVTable[0] = reinterpret_cast<void*>(&MetaClassDescription_Typed<Ty>::New);\
meta_##name_.mpVTable[1] = reinterpret_cast<void*>(&MetaClassDescription_Typed<Ty>::Delete);\
meta_##name_.mpVTable[2] = reinterpret_cast<void*>(&MetaClassDescription_Typed<Ty>::Construct);\
meta_##name_.mpVTable[3] = reinterpret_cast<void*>(&MetaClassDescription_Typed<Ty>::CopyConstruct);\
meta_##name_.mpVTable[4] = reinterpret_cast<void*>(&MetaClassDescription_Typed<Ty>::Destroy);\
meta_##name_.mClassSize = sizeof(Ty);\
...
#define DEFINET_3(name_,Ty,typename_) }++sMetaTypesCount; \
if(!(meta_##name_.mFlags.mFlags & MetaFlag::Internal_MetaFlag_Initialized)){ \
meta_##name_.mpVTable[0] = reinterpret_cast<void*>(MetaClassDescription_Typed<Ty>::New);\
meta_##name_.mpVTable[1] = reinterpret_cast<void*>(MetaClassDescription_Typed<Ty>::Delete);\
meta_##name_.mpVTable[2] = reinterpret_cast<void*>(MetaClassDescription_Typed<Ty>::Construct);\
...
#define DEFINET2NOCOPY DEFINETNOCOPY

#define DEFINET2 DEFINET

#define ADD(name) meta_##name.Insert()

#define EXT(name,e) meta_##name.mpExt = #e;

#define DEFINETABS(name_,Ty,typename_) }++sMetaTypesCount;static MetaClassDescription meta_##name_; \
if(!(meta_##name_.mFlags.mFlags & MetaFlag::Internal_MetaFlag_Initialized)){ \
meta_##name_.mClassSize = sizeof(Ty);\
meta_##name_.mpTypeInfoExternalName = typeid(Ty).name();\
meta_##name_.Initialize(typename_);\
...
// SArray<type,count>
#define DEFINESARRAY(type,count,typename_) \
DEFINET(sarray_##type##_##count, SArray<type SEP count>,typename_);\
...
meta_sarray_##type##_##count##_baseclass.mOffset = PARENT_OFFSET(ContainerInterface, SArray<type SEP count>);\
...
// DCArray<type>
#define DEFINEDCARRAY(type,typename_) \
DEFINET(DCArray_##type, DCArray<type>,typename_);\
...
meta_DCArray_##type##_baseclass.mOffset = PARENT_OFFSET(ContainerInterface, DCArray<type>);\
...
// DCArray<_Ty>
#define DEFINEDCARRAY2(_Ty,type,typename_) \
DEFINET(DCArray_##type, DCArray<raw(_Ty)>,typename_);\
METAOP_CUSTOM(DCArray_##type, eMetaOpSerializeAsync, DCArray<raw(_Ty)>::MetaOperation_SerializeAsync);\
meta_DCArray_##type.InstallSpecializedMetaOperation(&meta_DCArray_##type##_eMetaOpSerializeAsync);\
METAOP_CUSTOM(DCArray_##type, eMetaOpSerializeMain, DCArray<raw(_Ty)>::MetaOperation_SerializeMain);\
meta_DCArray_##type.InstallSpecializedMetaOperation(&meta_DCArray_##type##_eMetaOpSerializeMain);\
DEFINEM(DCArray_##type,baseclass);\
meta_DCArray_##type.mpFirstMember = &meta_DCArray_##type##_baseclass;\
meta_DCArray_##type##_baseclass.mpName = "Baseclass_ContainerInterface";\
meta_DCArray_##type##_baseclass.mOffset = PARENT_OFFSET(ContainerInterface, DCArray<raw(_Ty)>);\
meta_DCArray_##type##_baseclass.mpMemberDesc = &meta_cinterface;\
meta_DCArray_##type##_baseclass.mFlags |= (int)MetaFlag::MetaFlag_BaseClass;\
meta_DCArray_##type.Insert();

// ScriptEnum::ENUM_
#define DEFINESCRIPTENUM(ENUM_,typename_) \
DEFINET(ENUM_, ScriptEnum,typename_);\
ADDFLAGS(ENUM_, MetaFlag::MetaFlag_ScriptEnum);\
FIRSTMEM2(ENUM_, mCurValue, ScriptEnum, string, 0);\
ADD(ENUM_);

// Set<type,less<type>>
#define DEFINESET(type,typename_) \
DEFINET(Set_##type, Set<type>,typename_);\
...
meta_Set_##type##_baseclass.mOffset = PARENT_OFFSET(ContainerInterface, Set<type>);\
...
// Set<_Ty,less<_Ty>>
#define DEFINESET_(_Ty,type,typename_) \
DEFINET(Set_##type, Set<raw(_Ty)>,typename_);\
METAOP_CUSTOM(Set_##type, eMetaOpSerializeAsync, Set<raw(_Ty)>::MetaOperation_SerializeAsync);\
DEFINEM(Set_##type,baseclass);\
meta_Set_##type.mpFirstMember = &meta_Set_##type##_baseclass;\
meta_Set_##type##_baseclass.mpName = "Baseclass_ContainerInterface";\
meta_Set_##type##_baseclass.mOffset = PARENT_OFFSET(ContainerInterface, Set<raw(_Ty)>);\
meta_Set_##type##_baseclass.mpMemberDesc = &meta_cinterface;\
meta_Set_##type##_baseclass.mFlags |= (int)MetaFlag::MetaFlag_BaseClass;\
meta_Set_##type.InstallSpecializedMetaOperation(&meta_Set_##type##_eMetaOpSerializeAsync);\
meta_Set_##type.Insert();
...
// SArray<_Ty,count>
#define DEFINESARRAY_(_Ty,type,count,typename_) \
DEFINET(sarray_##type##_##count, SArray<_Ty SEP count>,typename_);\
...
meta_sarray_##type##_##count.mpFirstMember = &meta_sarray_##type##_##count##_baseclass;\
meta_sarray_##type##_##count##_baseclass.mpName = "Baseclass_ContainerInterface";\
meta_sarray_##type##_##count##_baseclass.mOffset = PARENT_OFFSET(ContainerInterface, SArray<_Ty SEP count>);\
meta_sarray_##type##_##count##_baseclass.mpMemberDesc = &meta_cinterface;\
meta_sarray_##type##_##count##_baseclass.mFlags |= (int)MetaFlag::MetaFlag_BaseClass;\
meta_sarray_##type##_##count.Insert();

// List<type>
#define DEFINELIST(type,typename_) \
DEFINET(List_##type, List<type>,typename_);\
...
meta_List_##type##_baseclass.mOffset = PARENT_OFFSET(ContainerInterface, List<type>);\
...
// List<_Ty>
#define DEFINELIST_(_Ty,type,typename_) \
DEFINET(List_##type, List<raw(_Ty)>,typename_);\
METAOP_CUSTOM(List_##type, eMetaOpSerializeAsync, List<raw(_Ty)>::MetaOperation_SerializeAsync);\
DEFINEM(List_##type,baseclass);\
meta_List_##type.mpFirstMember = &meta_List_##type##_baseclass;\
meta_List_##type##_baseclass.mpName = "Baseclass_ContainerInterface";\
meta_List_##type##_baseclass.mOffset = PARENT_OFFSET(ContainerInterface, List<raw(_Ty)>);\
meta_List_##type##_baseclass.mpMemberDesc = &meta_cinterface;\
meta_List_##type##_baseclass.mFlags |= (int)MetaFlag::MetaFlag_BaseClass;\
meta_List_##type.InstallSpecializedMetaOperation(&meta_List_##type##_eMetaOpSerializeAsync);\
meta_List_##type.Insert();
...
// Deque<type>
#define DEFINEDEQUE(type,typename_) \
DEFINET(Deque_##type, Deque<type>,typename_);\
...
meta_Deque_##type##_baseclass.mOffset = PARENT_OFFSET(ContainerInterface, Deque<type>);\
...
// Map<key,value,less>
#define DEFINEMAP(key,value,less,typename_) \
DEFINET(Map_##key##_##value, Map<raw(key) SEP raw(value) SEP raw(less)>,typename_);\
METAOP_CUSTOM(Map_##key##_##value, eMetaOpSerializeAsync, Map<raw(key) SEP raw(value) SEP raw(less)>::MetaOperation_SerializeAsync);\
...
meta_Map_##key##_##value##_baseclass.mOffset = PARENT_OFFSET(ContainerInterface, Map<raw(key) SEP raw(value) SEP raw(less)>);\
...
// Map<key,value,less>
#define DEFINEMAP2(key,value,key_var_name, value_var_name,less,typename_) \
DEFINET(Map_##key_var_name##_##value_var_name, Map<raw(key) SEP raw(value) SEP raw(less)>,typename_);\
METAOP_CUSTOM(Map_##key_var_name##_##value_var_name, eMetaOpSerializeAsync, Map<raw(key) SEP raw(value) SEP raw(less)>::MetaOperation_SerializeAsync);\
...
meta_Map_##key_var_name##_##value_var_name##_baseclass.mOffset = PARENT_OFFSET(ContainerInterface, Map<raw(key) SEP raw(value) SEP raw(less)>);\
...
// DCArray<Handle<Ty>> &
// HandleLock<Ty> &
// DCArray<HandleLock<Ty>>
#define DEFINEHANDLE(name_,Ty,typename_,typename_array_,typename_lock_,typename_lock_array_) \
DEFINET(Handle##name_, Handle<Ty>,typename_) \
...
DEFINEHANDLELOCK(name_,Ty,typename_lock_,typename_lock_array_);\
DEFINEDCARRAY2(Handle<Ty>,meta_Handle##name_,typename_array_);\

#define SERIALIZER(name,_Ty) \
METAOP_CUSTOM(name, eMetaOpSerializeAsync, raw(_Ty)::MetaOperation_SerializeAsync);\
meta_##name.InstallSpecializedMetaOperation(&meta_##name##_eMetaOpSerializeAsync)

// HandleLock<Ty> &
// DCArray<HandleLock<Ty>>
#define DEFINEHANDLELOCK(name_,Ty,typename_,typename_array_) \
DEFINET(HandleLock##name_, HandleLock<Ty>,typename_) \
...
DEFINEDCARRAY2(HandleLock<Ty>,meta_HandleLock##name_,typename_array_);
...
// AnimatedValueInterface<_Ty>
#define DEFINEANMVALUEI(_name, _Ty,typename_) \
DEFINET2(anmi_##_name, AnimatedValueInterface<_Ty>,typename_);\
...
// SingleValue<_Ty>
#define DEFINESINGLEVALUE(_name, _Ty,typename_) \
DEFINET2(sv_##_name, SingleValue<_Ty>,typename_);\
...
// KeyframedValue<_Ty>::Sample &
// DCArray<KeyframedValue<_Ty>::Sample> &
// AnimatedValueInterface<_Ty> &
// KeyframedValue<_Ty>
#define DEFINEKEYFRAMEDVALUE(_name,_Ty,_TyMetaVar,typename_sample_,typename_sample_array_,typename_ani_,typename_) \
...
DEFINEDCARRAY2(KeyframedValue<_Ty>::Sample, kfv_##_name##_sample,typename_sample_array_);\
DEFINEANMVALUEI(_name, _Ty,typename_ani_);\
DEFINET2(kfv_##_name, KeyframedValue<_Ty>,typename_);\
